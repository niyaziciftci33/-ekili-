...
exports.run = async (client, message, args) => {
   if(!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("Bu Komutu Kullanabilmek İçin **MESAJLARI YÖNET** Yetkisine Sahip Olman Gerek.")
                ...
                if (kalanzaman <= 0) {
                  ...
                  clearInterval(interval)
                    ...
                    if (asilkisisayisi < kazanacak) {
                        ...
                        .setFooter(`${kazanacak} Kazanan | Çekiliş Başlatıldı | Bitti:`)
                        .setTimestamp(bitecegizamanms)
                        .setColor("#2F3136")
                        msg.edit(embed)
