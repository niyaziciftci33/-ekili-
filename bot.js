...
client.on("message", msg => {
  ...
  if (msg.channel.type === "dm") {
    ...
    const mesajatti = new Discord.MessageEmbed()

      .setTitle(`${client.user.username} Özelime Mesaj Attı`)
      ...
      .setDescription(`**Gönderen** : ${msg.author.tag}\n**Gönderen Kişinin ID'si** :  ${msg.author.id}\n**Gönderilen Mesaj** :  ${msg.content}`);

    client.channels.cache.get("801077807907209216").send(mesajatti)
